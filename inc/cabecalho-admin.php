...
/* Inicializando do Output Buffer
Gerenciamento da memória de saídas/redirecionamento */
ob_start();
...
<body id="admin" class="d-flex flex-column h-100 bg-ligth bg-gradient">
  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
            <li class="nav-item">
            <?php if($_SESSION['tipo'] === 'admin') { ?> <!-- segundo jeito de fazer -->
        ...
        <?php } else { ?> <!-- segundo jeito de fazer -->
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
            <li class="nav-item">
            <a class="nav-link" href="index.php">Home</a>
            </li>
